            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-justify mt-2.5">
                        Your X account must be public and not have restricted settings. Some features may be limited
                        depending on your account settings or platform restrictions.
                    </DialogDescription>
                </DialogHeader>
