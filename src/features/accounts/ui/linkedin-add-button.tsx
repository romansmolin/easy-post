            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-justify mt-2.5">
                        You need a personal LinkedIn profile to connect. Some features like posting may only work for
                        profiles that are actively maintained and not restricted. Make sure your profile is up to date.
                    </DialogDescription>
                </DialogHeader>
